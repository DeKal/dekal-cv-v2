...
\hypersetup{
    colorlinks=true,
    linkcolor=awesome-orange,
    urlcolor=awesome-orange,
    linkbordercolor=awesome-orange,
...
\name{Ho}{Phat}
\position{Backend {\enskip\cdotp\enskip} Lead engineer}

\mobile{(+84) 09-0632-3761}
\email{hohuuphat22@gmail.com}
\homepage{https://phatho-dev.com/}
\github{DeKal}
\linkedin{phat-ho}
% \gitlab{gitlab-id}
